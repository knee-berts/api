...
events.on("push", (brigadeEvent, project) => {
    ...
    brigConfig.set("apiImage", "azureworkshop/rating-api")
...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-api-deploy heroes-api-cntnr=njeacr.azurecr.io/azureworkshop/rating-api:${config.get("imageTag")}`
    ]
}
